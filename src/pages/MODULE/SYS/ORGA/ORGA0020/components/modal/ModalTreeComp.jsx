...
function ModalTreeComp({ topDepartment, handleSelectDepartment }) {
      ...
      {topDepartment.map((item) => (
        <List key={item.deptNo}>
          <Department>
            ...
            <span
              onClick={() => handleSelectDepartment(item.deptNo)}>{item.deptNo} -- {item.deptName}
            </span>
          </Department>
