      ...
      <div>
        ...
        <div>
          ...
          <input
            type="text"
            name="empName"
            onChange={(e) => { handleOnChangeEmployee(e); }}
          />
        </div>
        ...
        <div>
          <span> 비밀번호 </span>
          <input type="password" name="password" onChange={(e) => { handleOnChangeEmployee(e); }} />
        </div>

        <div>
          <span> 성별 </span>
          <select name="gender" onChange={(e) => { handleOnChangeEmployee(e); }}>
        ...
        <div>
          <span> 이메일 </span>
          <input type="email" name="email" onChange={(e) => { handleOnChangeEmployee(e); }} />
          {/* {...register("email", { required: true })} */}
        </div>

        <div>
          <span> 휴대전화 </span>
          <input type="text" name="empPhone" onChange={(e) => { handleOnChangeEmployee(e); }} />
        </div>

        <div>
          <span> 주소 </span>
          <input type="text" name="empAddress" onChange={(e) => { handleOnChangeEmployee(e); }} />
          <button type="button">우편번호</button>
        </div>

        <div>
          <span>권한</span>
          <input name="empRole" type="radio" value="ROLE_USER" onChange={(e) => { handleOnChangeEmployee(e); }} />일반
          <input name="empRole" type="radio" value="ROLE_ADMIN" onChange={(e) => { handleOnChangeEmployee(e); }} />관리자
        </div>
      </div>
